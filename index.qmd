...
: Pipeline funnel under baseline (all 78 events) and sensitivity (71 events excluding the seven Garcia et al. flag for `bld_claims_ratio > 20`). {#tbl-sens-funnel}
