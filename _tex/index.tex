...
historically underserved communities. Whether participation actually
serves these households, however, requires post-mitigation outcome data
we do not have; this is particularly relevant for buyouts, where prior
research has questioned whether participation reflects informed
preference or limited alternatives
\citep{machManagedRetreatVoluntary2019}. Within block groups, funded
properties are typical of the local housing stock rather than the
cheapest, suggesting that within-community project selection does not
systematically filter out lower-value homes. The broader compositional
shift we observe is determined largely by upstream pipeline stages such
as community participation, application rates, and the spatial
distribution of flood exposure itself, rather than by within-community
project selection. Procedural neutrality at any one step is not
...
the pipeline occurs at the application step, and properties that reach
subsequent stages tend to be lower-value and concentrated in less-white
neighborhoods, primarily through between-neighborhood selection rather
than within-neighborhood selection. These results identify the
application stage as a leverage point for expanding access to federal
mitigation funding, one that prior work focused on funded outcomes alone
has been unable to observe.
