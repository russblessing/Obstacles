...
\citep{bubeck2012review, binderUpheavalUnpackingDynamic2023}. These
analyses, however, have observed only who receives funding, not who is
eligible or who applies. As a result, it remains unclear where in the
...
The main-text comparison of buyouts and elevations (Fig. X in main text)
restricts to the ``all funded'' subset. The figures below replicate that
comparison while also showing the repeat-flooded subset (Panel B), to
verify that the buyout-elevation divergence is not driven by
event-specific dynamics.
